---
title: Node.js アプリ
description: devinit を使用し、Node.js Express プロジェクトの npm パッケージをインストールするサンプル リポジトリ。
ms.date: 11/04/2020
ms.topic: reference
author: andysterland
ms.author: andster
...
ms.locfileid: "108635321"
---
# <a name="nodejs-app"></a>Node.js アプリ
...
devinit を使用し、Node.js Express プロジェクトの npm パッケージをインストールする例の完全版が必要な場合、[devinit-example-nodejs](https://github.com/microsoft/devinit-example-nodejs) リポジトリをご覧ください。
