...
Visual Studio のバージョンによっては、DGML 機能のサブセットのみがサポートされることに注意してください。「[アーキテクチャ ツールとモデリング ツールのバージョン サポート](../modeling/analyze-and-model-your-architecture.md#VersionSupport)」を参照してください。
