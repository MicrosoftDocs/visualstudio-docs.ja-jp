---
description: コンパイラ固有のフレームの種類を取得します。
...
[出力] コンパイラ固有のフレームの種類を示す [StackFrameTypeEnum 列挙型](../../debugger/debug-interface-access/stackframetypeenum.md)の列挙の値を返します。
