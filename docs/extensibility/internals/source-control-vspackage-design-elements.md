...
description: ソース管理 VSPackage で実装する必要がある構造体と、ソース管理 VSPackage で実装できるインターフェイスおよびサービスについて説明します。
...
このセクションのトピックでは、密接な統合のためにソース管理 VSPackage で実装する必要がある構造体の概要を示します。 また、ソース管理 VSPackage で実装できるインターフェイスとサービス、および、ソース管理 VSPackage で、そのソース管理のモデルと機能をサポートするために他の [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] コンポーネントから使用できるインターフェイスとサービスの一覧も示します。
...
- [関連サービスとインターフェイス](../../extensibility/internals/related-services-and-interfaces-source-control-vspackage.md)
 ...
 ソース管理パッケージに関連したインターフェイスとサービスを一覧表示します。
...
- [ソース管理 VSPackage の作成](../../extensibility/internals/creating-a-source-control-vspackage.md)
 ...
 ソース管理機能を提供するだけでなく、[!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] ソース管理 UI をカスタマイズするために使用できるソース管理 VSPackage を作成する方法について説明します。
