---
title: 従来の言語サービスの機能 2 |Microsoft Docs
description: Visual Studio SDK の Managed Extensibility Framework (MEF) 拡張機能を使用して提供できる、従来の言語サービスの機能について説明します。
...
---
# <a name="legacy-language-service-features-2"></a>従来の言語サービスの機能 2
次のトピックでは、提供できる従来の言語サービスの機能の一部を示します。
