---
title: 'CA0054: カスタム規則アセンブリに含まれる XML リソースが無効です。'
description: これは、カスタム規則アセンブリに含まれ、その規則を説明する XML リソースが無効なときに発生します。
ms.date: 10/19/2016
ms.topic: reference
f1_keywords:
- CA0054
...
カスタム規則アセンブリに含まれる XML リソースが無効です。

これは、カスタム規則アセンブリに含まれ、その規則を説明する XML リソースが無効なときに発生します。 正しい形式は次のようになります。
