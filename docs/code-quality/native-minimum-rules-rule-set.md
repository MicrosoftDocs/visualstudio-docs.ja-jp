...
ms.date: 11/04/2016
description: Visual Studio の "ネイティブ最小規則" 規則セットについて説明します。 ネイティブ コードのセキュリティ、堅牢性、およびその他の重要な問題の規則に関する説明を参照してください。
...
Microsoft ネイティブ最小規則は、ネイティブ コードの最も重大な問題 (潜在的なセキュリティ ホールやアプリケーションのクラッシュなど) に関するものです。
