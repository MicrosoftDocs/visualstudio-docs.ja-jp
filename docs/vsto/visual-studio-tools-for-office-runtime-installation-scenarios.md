...
|Office 2013 以降を使用する場合|はい|○ (.NET Framework Version 3.5 がインストール済みの場合)|○ ([!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)] がインストール済みの場合)|○ ([!INCLUDE[net_v45](../vsto/includes/net-v45-md.md)] がインストール済みの場合)|
...
### <a name="install-the-runtime-with-office"></a>Office でランタイムをインストールする
 ...
 該当するバージョンの .NET Framework がコンピューターに既に存在する場合、[!INCLUDE[net_v40_short](../sharepoint/includes/net-v40-short-md.md)] 以降の Office 拡張機能も Office と共にインストールされます。
