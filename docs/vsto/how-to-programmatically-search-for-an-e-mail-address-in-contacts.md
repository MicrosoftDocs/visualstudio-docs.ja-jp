---
title: プログラムで連絡先の電子メール アドレスを検索する
description: Visual Studio を使用して、Microsoft Outlook の連絡先の電子メール アドレスをプログラムで検索する方法について学習します。
...
---
# <a name="how-to-programmatically-search-for-an-email-address-in-contacts"></a>方法: プログラムによって連絡先から電子メール アドレスを検索する
