...
description: Office ソリューションの構築に使用されるサンプル アプリケーション、サンプル コードを紹介し、構文、構造、技法について段階的に説明します。
...
# <a name="office-development-samples-and-walkthroughs"></a>Office 開発のサンプルとチュートリアル
 ...
 アプリケーションをセキュリティで保護する方法については、「[セキュリティで保護された Office ソリューション](../vsto/securing-office-solutions.md)」を参照してください。
...
|[セキュリティおよび配置に関するチュートリアル](../vsto/security-and-deployment-walkthroughs.md)|ソリューションを実行するためのセキュリティ ポリシーの設定方法、およびソリューションの配置方法に関する詳細なガイドの一覧を示します。|
...
|[Visual Studio の Office ソリューションのアーキテクチャ](../vsto/architecture-of-office-solutions-in-visual-studio.md)|マネージド コードを使用する Office ソリューションの動作について開発者とエンド ユーザーの視点から説明し、マネージド コードと Office ドキュメントや Office アプリケーションの連携に関する情報を示します。|
